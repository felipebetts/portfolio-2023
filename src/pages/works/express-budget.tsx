    ...
    <WorkDetails sub="iBuild" title="Express Budget">
      ...
      <section className="py-3">
        <p className="my-2">
          ...
          webapp went live, the company's budgeting department was struggling
          with clients that asked for house budgets, only to find out that the
          budget was too high for them, generating work that didn't turned to
          revenue. The main goal of the app was to generate leads with loads of
          data about the clients, and to optimize the budgeting department's
          time.
        </p>
        <LazyImage
          height={600}
        ...
        <p className="my-2">
          ...
          access to the final report. By my client's request, this data is sent
          to Bitrix24, via their own api, and stored as a lead. Finally the user
          is able to see a resumed report of their choices and final budget
          generated.
        </p>
      </section>
    </WorkDetails>
